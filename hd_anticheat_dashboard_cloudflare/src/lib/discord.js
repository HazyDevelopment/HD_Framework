// Identical logic to the Node version — only touches `fetch`, which
// Workers provides natively, so nothing here needed to change beyond
...
export async function postBanToDiscord(ban, webhookCfg, screenshotUrls) {
