...
--
-- Same shape as uk_uhsjob: ranks/loadout config, armoury, GPS. GPS
-- deliberately reuses uk_uhsjob's existing client-side blip renderer
-- (event names ukhs:client:gpsUpdate / ukhs:client:gpsRemove) instead
-- of building a parallel one — that renderer already color-codes
-- police blips blue, it just never had anything pushing "police"
-- units into it before now.
-- ═══════════════════════════════════════════════════════════════════
