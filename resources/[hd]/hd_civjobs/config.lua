...
Config.Jobs.reporter = {
    ...
    depot = nil,
    office = vector3(-599.5, -930.8, 23.9), -- newsroom, doubles as the permanent map blip since there's no depot to anchor one to
...
Config.Jobs.realestate = {
    ...
    vehicle = nil,
    depot = nil,
    office = vector3(-1035.0, -200.0, 37.0), -- estate office, doubles as the permanent map blip since there's no depot to anchor one to
