...
if Config.AutoTriggers.PlayerDowned.Enabled then
    ...
    -- this on vanilla death — hd_ems hooks the exact same event
    -- independently for its own downed-state handling, so both this
    -- and hd_ems fire off the identical moment with nothing to keep
