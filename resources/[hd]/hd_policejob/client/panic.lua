-- ═══════════════════════════════════════════════════════════════════
--  hd_policejob | client/panic.lua
--  /panic — resolves the officer's own street name (a client native,
...
RegisterCommand(Config.Panic.Command, function()
    ...
    TriggerServerEvent('hdpolice:server:panic', { x = coords.x, y = coords.y, z = coords.z }, StreetLabel())
end, false)
