...
-- ═══════════════════════════ GIVE ITEM ═══════════════════════════════
-- Dragging an item onto the middle panel's Give button (html/js/app.js)
-- hands it straight to whoever's physically closest, no manual target
-- picking — server/inventory.lua re-derives the closest player itself
-- from real ped coordinates, same "never trust the client on who the
-- target is" rule every other proximity-gated action in this build
-- already follows.
